defmodule P00Test do
  ...
  def solve() do
    ...
    "[[テストです]]" |> _remove_link |> IO.puts
    "[[ファイル:Wikipedia-logo-v2-ja.png|thumb|説明文]]" |> WikiParser.remove_file_link |> IO.puts
    "#REDIRECT [[test]]" |> WikiParser.remove_redirect_markup |> IO.puts
    "63,181,775<ref>[http://esa.un.org/unpd/wpp/Excel-Data/population.htm United Nations Department of Economic and Social Affairs>Population Division>Data>Population>Total Population]</ref>" |>
      WikiParser.remove_external_link |> IO.puts
